...
public class RopeAttachment : MonoBehaviour, Interactable, Hoverable
{
	...
	private void FixedUpdate()
	{
		...
		{
			Vector3 vector = ((m_puller.transform.position - base.transform.position).normalized * m_maxPullVel - m_boatBody.GetPointVelocity(base.transform.position)) * m_pullForce;
			m_boatBody.AddForceAtPosition(base.transform.position, vector);
		}
	}
}
